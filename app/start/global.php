...
App::error(function(RuntimeException $exception, $code)
{
    ...
    if (Request::is('api/*')) {
        ...
        switch ($code) {
            case 400:
                $subject = 'Bad Request';
                $body = 'Bad input parameter.';
                break;

            case 401:
                $subject = 'Unauthorized';
                $body = 'Bad token or invalid signature.';
                break;

            case 403:
                $subject = 'Forbidden';
                $body = 'Bad auth request.';
                break;
            ...
            case 405:
                ...
                $body = 'Request method not expected.';
                break;
...
App::missing(function($exception)
{
    ...
    // $this->layout = View::make($layout, 404)
